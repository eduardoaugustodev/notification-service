package br.com.notification.api.controller;
...
public class NotificationServiceResourceTest {
	...
	void deveEnviarEmailComSucesso(){
    	...
    	ResponseEntity<NotificationResponse> response = restTemplate.postForEntity(urlBase, request, NotificationResponse.class);
